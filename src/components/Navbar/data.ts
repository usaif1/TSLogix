// dependencies
import {  House, Gear, Database, FileText, Package, ClockCounterClockwise  } from "@phosphor-icons/react";
...
const getAllLinksData = (t: TFunction) => [
    ...
    },
    {
      ...
      icon: FileText,
      subroutes: [
        { title: t('reports:warehouse_layout'), route: "/warehouse" },
        { title: t('reports:other_reports'), route: "/reports" },
      ],
    },
    {
      title: t('inventory'),
